...
#STEP 0:
python /scratch/lisu/lisu_git/scenic_application/post_scenic_original.py --prefix ${prefix} --wdir ${working_dir} --path_ad_file_from_seurat_integrated ${path_ad_file_from_seurat_integrated} 
